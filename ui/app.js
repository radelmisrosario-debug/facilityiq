...
const assetFamilies=[
  ...
  {id:"pumps",name:"Hydronic Pumps",short:"P",description:"Primary, secondary, chilled-water, and hot-water pumps",match:a=>a.category.includes("Pump")&&!a.category.includes("Vacuum")&&!a.id.includes("VACP")},
