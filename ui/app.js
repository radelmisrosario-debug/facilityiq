...
function renderAsset(asset){
  ...
  const controlsNote=asset.category==="Air Handling Unit"?`<div class="operating-note"><strong>AHU control relationships</strong><p>Cooling depends on chilled water at the active Desigo setpoint and pneumatic control air from the House Air Compressors. The heating valve is normally open and the cooling valve is normally closed; loss of control air can create simultaneous heating and loss of cooling.</p></div>`:asset.id.startsWith("House-AC-")?`<div class="operating-note"><strong>Control-air dependency</strong><p>This compressor is part of the control-air source for the AHU pneumatic valves. Low header or branch pressure can leave heating valves open and cooling valves closed.</p></div>`:"";
