  ...
  sections:[
    {
      ...
      facts:["Desigo controls air handlers, chillers, boilers, exhaust fans, unit heaters, temperature control, CAV/VAV systems, utility pumps, and Siemens-controlled fume hoods.","Authorized operators can review trends and adjust approved setpoints or overrides.","For Siemens-controlled fume hoods, Desigo displays airflow and supports approved airflow/face-velocity setpoint adjustment.","Lab 400 fume hoods use a separate control arrangement from the standard Desigo fume-hood sequence."],
    ...
    },
    {
      ...
      facts:["All laboratories are single-pass air spaces: the AHU supplies conditioned air and the laboratory exhaust system removes that air to the outdoors.","AHUs equipped with return fans may recirculate return air from office spaces, but laboratory air is not returned or recirculated.","AHU-01, AHU-02, and AHU-04 use outside-air-temperature-based return-fan setpoint control.","AHU-05 and AHU-06 do not use return-fan temperature reset.","Cooling depends on the chilled-water plant. Pneumatic AHU heating and cooling valves depend on the dedicated Control Air Compressor and dryer.","AHU heating valves are normally open and cooling valves are normally closed."],
      operations:["For a space complaint, begin with occupancy, effective setpoint, sensor accuracy, serving terminal, airflow, damper response, and VAV heating-valve response.","For a laboratory airflow or pressure complaint, evaluate AHU supply and laboratory exhaust together because laboratory air is single-pass to the outdoors.","For widespread warm conditions, check chilled-water supply versus active setpoint, secondary-loop DP, and common control-air pressure before investigating every AHU independently.","Verify return-fan reset logic against outside-air temperature for AHU-01, AHU-02, and AHU-04."],
    ...
    },
    {
      ...
      facts:["All laboratories use single-pass ventilation: AHUs provide supply air and the laboratory exhaust fans discharge it outdoors rather than returning it to an AHU.","EF-10/11: all fume hoods in Labs 400 and 505.","EF-21/22: all fume hoods in Labs 430 and 440.","EF-25/26: all fume hoods in Labs 415 and 420 plus the sink exhaust in Lab 414.","EF-27/28: all fume hoods in Labs 450 and 460.","EF-30/31: Bio-side laboratory fume hoods and exhaust points.","Desigo maintains duct static pressure by modulating the roof dampers as system pressure changes."],
      operations:["For a pair-wide complaint, check both fans’ enable, proof, speed, current, faults, rotation, and disconnects, then compare common duct static with setpoint.","If all connected points are affected, check shared controls, static sensor, roof/common dampers, common duct and discharge, AHU make-up/supply air, and simultaneous demand.","If one point is affected, check its hood/sink pickup, sash, alarm, airflow controller, pneumatic actuator, branch damper, sensor, and branch duct.","Verify hood face velocity or approved containment performance before returning a hood to use."],
    ...
    },
    {
      ...
      facts:["Each fume hood maintains its approved face-velocity setpoint.","A pneumatic actuator modulates the damper above each hood to control airflow.","Fume hoods equipped with Siemens controllers are integrated with Desigo, where authorized operators can view airflow and adjust approved setpoints as operating needs require.","The dedicated Control Air Compressor and Control Air Dryer supply pneumatic air to the fume-hood actuators as well as AHU valve actuators.","Lab 400 uses a separate control arrangement that must be verified before applying the standard Siemens/Desigo sequence."],
      operations:["Check sash position, hood alarm, face-velocity actual and setpoint, Desigo airflow value, controller command, damper feedback, local sensor, branch static, and make-up air.","For a Siemens-controlled hood, confirm the approved setpoint and actual airflow in Desigo before making an adjustment.","If one hood responds poorly, inspect its pneumatic actuator, control-air branch pressure and tubing, Siemens controller, sensor, sash, and branch duct.","If multiple hood actuators and AHU valves respond poorly, check Control-AC, its dryer, the control-air header, regulators, isolation valves, and leaks.","Compare a failing hood with a normal hood on the same paired fan system to separate local and common causes.","Change a face-velocity setpoint only under an approved containment/safety procedure."],
    ...
    },
    {
      ...
      summary:"The facility has two different compressed-air systems. Control air operates AHU pneumatic valves. House-AC-01/02 supply Chemistry-side laboratory air, while House-AC-03 supplies Bio-side laboratory air. Troubleshoot them as separate systems.",
      facts:["The dedicated Control Air Compressor and dryer supply pneumatic control air to AHU heating/cooling valves and pneumatic fume-hood damper actuators.","House Air Compressors 01–03 supply laboratory compressed-air demand and do not provide normal control air for AHU valves or fume-hood actuators.","Each House Air Compressor has its own dedicated refrigerated air dryer: 01 to 01, 02 to 02, and 03 to 03.","A low-pressure backup arrangement is set near 30 PSI. Verify the valve lineup before relying on backup operation."],
      operations:["For AHU valve or pneumatic fume-hood actuator problems, check Control-AC, dryer, receiver/header pressure, regulators, isolation valves, tubing, branch pressure, and actuator response.","If multiple Siemens-controlled hood actuators and AHU valves respond poorly, treat low control-air pressure or distribution leakage as a possible common cause.","For low laboratory air pressure at user outlets, check the active House Air Compressor and its dedicated air dryer, receiver/header pressure, pressure drop, demand, drains, regulators, isolation valves, and leaks.","For wet laboratory air, verify the serving dryer refrigeration circuit, condenser airflow, separator, automatic drain, filters, bypass position, and outlet dew point.","Keep AHU/fume-hood control air and laboratory user air diagnoses separate unless an approved cross-connect/backup arrangement is confirmed."],
    ...
    },
    {
      ...
      facts:["The Cummins generator is rated 500 kW and uses a 1,200-gallon fuel tank.","A full generator fuel tank provides approximately three days of operation under the facility’s expected emergency operating conditions.","Generator-supported loads include stability chambers, UPS systems, BAS, exhaust fans, and lighting.","Boilers, chillers, and AHUs are not generator-supported.","The Eaton UPS is rated 200 kW and currently provides approximately 40 minutes of runtime when the generator does not start."],
      operations:["During an outage, confirm UPS transfer to battery, generator start and stabilization, ATS transfer, UPS return to acceptable input, and battery recharge.","Track fuel level and actual consumption throughout an extended outage; the three-day duration is a planning estimate and changes with electrical load, usable tank volume, generator condition, and fuel-system performance.","Prioritize supported critical loads and monitor UPS runtime, load, alarms, temperature, and battery condition.","Do not expect boilers, chillers, or AHUs to run on emergency power unless the electrical one-line confirms otherwise."],
